...
NetherOrePopulator::NetherOrePopulator(int_fast32_t worldHeight) {
  ...
  AddOre(OreType{GOLD_ORE_NETHER, 10, worldHeight - (10 * (worldHeight >> 7)), 13, static_cast<int>(NETHERRACK.GetId()), 8});
  AddOre(OreType{ANCIENT_DEBRIS, 10, worldHeight - (10 * (worldHeight >> 7)), 13, static_cast<int>(NETHERRACK.GetId()), 2});
